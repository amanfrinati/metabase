...
(def ^:private ExecutePermissions
  (s/named
   (s/enum :all :none)
...
(def ^:private StrictExecutionGroupPermissionsGraph
  (s/cond-pre ExecutePermissions
              {su/IntGreaterThanZero ExecutePermissions}))

(def ^:private StrictExecutionPermissionsGraph
  {:revision s/Int
   :groups   {su/IntGreaterThanZero StrictExecutionGroupPermissionsGraph}})
...
(s/defn ^:private update-execution-permissions!
  [group-id :- su/IntGreaterThanZero new-group-perms :- StrictExecutionGroupPermissionsGraph]
...
(s/defn update-execution-perms-graph!
  ...
  Code for updating the Collection permissions graph is in [[metabase.models.collection.graph]]."
  ([new-graph :- StrictExecutionPermissionsGraph]
